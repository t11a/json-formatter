...
import { Copy, Check, FileJson, Settings, ChevronDown, Download, AlignLeft, Network } from 'lucide-react';

const Controls = ({ indent, onIndentChange, output, viewMode, onViewModeChange }) => {
    ...
    return (
        ...
        >
            {/* View Mode Toggle */}
            <div style={{ display: 'flex', backgroundColor: 'var(--bg-secondary)', borderRadius: '4px', padding: '2px', border: '1px solid var(--border-color)' }}>
                <button
                ...
                <button
                    ...
                    style={{
                        ...
                        alignItems: 'center',
                        gap: '0.5rem',
                        backgroundColor: viewMode === 'tree' ? 'var(--bg-primary)' : 'transparent',
            ...
            <button
                ...
                style={{
                    ...
                    padding: '0.25rem 0.75rem',
                    borderRadius: '4px',
                    cursor: viewMode === 'tree' ? 'not-allowed' : 'pointer',
                    fontSize: '0.875rem',
                    transition: 'all 0.2s',
                    opacity: viewMode === 'tree' ? 0.5 : 1,
                }}
                title="Minify JSON"
            >
                <FileJson size={16} />
